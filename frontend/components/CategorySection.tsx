...
export const CategorySection = async ({
    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-5 md:gap-8  max-w-fit mx-auto">
            {categories.length === 0 ? (
                ...
                categories.map((category) => (
                    ...
                    >
                        ...
                        <div className="h-full flex flex-col justify-between items-center gap-1 mt-4">
                        <p className=" capitalize text-base md:text-lg ">{category.name}</p>
                        <p
